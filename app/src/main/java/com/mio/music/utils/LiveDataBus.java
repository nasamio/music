...
public class LiveDataBus {
    ...
    private static class BusMutableLiveData<T> extends MutableLiveData<T> {
        ...
        @Override
        public void observeForever(@Nullable Observer<? super T> observer) {
        ...
        @Override
        public void removeObserver(@Nullable Observer<? super T> observer) {
        ...
        private void hook(@Nullable Observer<? super T> observer) throws Exception {
            // 获取livedata的class对象
